//
//  WebRes4ViewController.swift
//  MapAppCombined
//
//  Created by QA&Testing on 3/28/18.
//  Copyright © 2018 UVMMC Interns. All rights reserved.
//

import UIKit

class WebRes4ViewController: UIViewController {
